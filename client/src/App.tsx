...
function App() {
  ...
  return (
    <div className='w-auto overflow-hidden'>
       <div id="nav" className='flex px-17 lg:px-40 py-5 h-[60px] lg:h-[70px] w-auto bg-white'>
        ...
        <div id="services-container" className='flex justify-center bg-white px-10 py-10 '>
          <div className='flex flex-col lg:flex-row lg:space-x-10'>
            <img ref={view2.ref} src="/services.svg" alt="" className={`w-[600px] h-[600px] hidden lg:block ${view2.inView ? 'transition duration-1500 ease-in-out opacity-100 translate-y-0' : 'transition duration-1500 ease-in-out opacity-0 translate-y-10'}`}/>
            <div ref={view3.ref} className={`flex flex-col space-y-10 ${view3.inView ? 'transition duration-2000 ease-in-out opacity-100 translate-x-0' : 
       ...
       <div ref={view4.ref} id="team-container" className={`flex px-10 md:px-35 lg:justify-center lg:px-10 py-10 
       bg-[#F5F5F5] ${view4.inView ? 'transition duration-2000 ease-in-out opacity-100 translate-x-0' : 
        'transition duration-1000 ease-in-out opacity-0 translate-x-10'}`}>
